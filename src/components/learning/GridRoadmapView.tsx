...
const statusConfig = {
  ...
  locked:        { label: "Locked", color: "bg-slate-50 text-slate-400 border-slate-200" },
} as const;
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Week {week.weekNumber} · {week.sessions.length} sessions</p>
              </div>
            </div>
