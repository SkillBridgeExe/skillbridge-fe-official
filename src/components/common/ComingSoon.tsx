...
/**
 * Trạng thái "Sắp ra mắt" cho tính năng đã tắt qua FEATURES (vd backend chưa sẵn sàng).
 * Dùng ở tầng route nên trang thật không mount → không bắn request lỗi.
 */
export default function ComingSoon({ feature }: { feature: "interview" | "roadmap" }) {
