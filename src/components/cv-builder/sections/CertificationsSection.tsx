  ...
  return (
    <div className="space-y-6">
      {certifications.map((cert, index) => {
        const title = cert.name || t("builder.ph.certName", { defaultValue: "Tên chứng chỉ" });
        const subtitle = cert.organization || t("builder.entry.certification", { defaultValue: "Chứng chỉ" });
