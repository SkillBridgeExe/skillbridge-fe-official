import type { ResumeData, SectionType } from "@resume-engine/schema/resume/data";
import { getDefaultSectionIconName } from "@resume-engine/schema/resume/section-icons";
