...
import { parseColorString, rgbaStringToHex } from "@resume-engine/utils/color";
...
import { composeStyles, headerNameLineHeight, resolveDividerStyles, resolvePlacementColor } from "../shared/styles";
