...
import type { ResumeData, StyleIntent, StyleSlot } from "@resume-engine/schema/resume/data";
import type { SectionStyleRuleContext } from "@resume-engine/schema/resume/style-rules";
import { getSectionStyleRuleContext, resolveStyleIntentForSlot } from "@resume-engine/schema/resume/style-rules";
import { rgbaStringToHex } from "@resume-engine/utils/color";
