import type { FontWeight } from "@resume-engine/fonts";
import type { ResumeData, Typography } from "@resume-engine/schema/resume/data";
import type { Locale, Script } from "@resume-engine/utils/locale";
...
import {
	...
	sortFontWeights,
} from "@resume-engine/fonts";
import { isCJKLocale } from "@resume-engine/utils/locale";
