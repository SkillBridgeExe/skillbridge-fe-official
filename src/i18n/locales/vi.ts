export default {
  common: {
    ...
    learning: {
      wizard: {
        ...
        goal: {
          ...
          careerTitle: "Chuẩn bị cho một nghề",
          careerBody: "So sánh một CV của bạn với khung kỹ năng của nghề mục tiêu.",
          jdNeedsDiagnosis:
            "Lộ trình theo công việc cần kết quả phân tích CV × JD. Hãy sang trang Phân tích để chọn CV và mô tả công việc.",
        },
        context: {
          cv: "CV nguồn",
          chooseCv: "Chọn một CV",
          role: "Nghề mục tiêu",
        ...
        schedule: {
          days: "Ngày học",
          time: "Giờ bắt đầu",
          session: "Thời lượng buổi",
          slot: "Thời gian có thể học",
          deadline: "Hạn hoàn thành",
          flexibleTitle: "Lịch học linh hoạt",
          flexibleBody:
            "Bạn chỉ cần chọn ngày bắt đầu và số ngày muốn học mỗi tuần. SkillBridge sẽ dự kiến ngày hoàn thành, không đặt deadline và không ép giờ học cố định.",
          startDate: "Ngày bắt đầu",
          daysPerWeek: "Số ngày học mỗi tuần",
          daysPerWeekOption: "{{count}} ngày học mỗi tuần",
          sessionHint:
            "Mỗi buổi được thiết kế trong khoảng 60 phút. Bạn vẫn có thể học sớm hơn hoặc xem lại bất kỳ bài nào đã mở.",
        },
        ...
        preview: {
          ...
          lessonMinutes: "{{count}} phút",
          calculating: "Đang tính",
          durationUnknown: "Chưa rõ thời lượng",
          duration: {
            exactMinutes: "{{minutes}} phút",
            estimatedMinutes: "Khoảng {{minutes}} phút",
            exactHours: "{{hours}} giờ",
            estimatedHours: "Khoảng {{hours}} giờ",
            exactHoursMinutes: "{{hours}} giờ {{minutes}} phút",
            estimatedHoursMinutes: "Khoảng {{hours}} giờ {{minutes}} phút",
          },
        },
        track: {
          fastTitle: "Lộ trình cấp tốc",
          foundationTitle: "Lộ trình nền tảng",
          sessionSummary: "{{count}} buổi · {{minutes}} phút/buổi",
          fastBody:
            "Ưu tiên phần cốt lõi có tác động cao để upskill nhanh và tập trung.",
          foundationBody:
            "Giữ đầy đủ kiến thức nền tảng và prerequisite theo nhịp học bạn đã chọn.",
        },
        scope: {
          full: "Đầy đủ",
          core_only: "Phần cốt lõi",
          intro_only: "Nhập môn",
          deferred: "Để học sau",
        },
        errors: {
          chooseCv: "Hãy chọn một CV trước khi tiếp tục.",
          startDateRequired: "Hãy chọn ngày bắt đầu học.",
        ...
        previewAction: "Xem trước lịch",
        generateAction: "Tạo lộ trình",
      },
      page: {
        title: "Học tập",
        ...
        retry: "Thử lại",
        loadError: "Không thể tải lộ trình học của bạn.",
        contentSourceAi: "Nội dung AI tối ưu",
        contentSourceStandard: "Nội dung tiêu chuẩn",
        trackFast: "Cấp tốc",
        trackFoundation: "Nền tảng",
      ...
      sidebar: {
        ...
        completedCompact: "{{done}}/{{total}} đạt",
        remainingCompact: "{{remaining}}/{{total}} còn lại",
        learnNow: "Học ngay",
      ...
      projection: {
        ...
        estimatedCompletion: "Dự kiến hoàn thành",
        progressLabel: "Tiến độ hoàn thành lộ trình",
        missedSessions: "Bạn có {{count}} buổi theo kế hoạch chưa hoàn thành.",
        dialogTitle: "Xếp lại lịch học",
        dialogBody:
          "Các buổi đã hoàn thành được giữ nguyên. SkillBridge chỉ phân bổ lại những buổi còn lại.",
        startDate: "Bắt đầu lại từ ngày",
        daysPerWeek: "Số ngày học mỗi tuần",
        update: "Cập nhật lịch",
        rescheduleSuccess: "Đã xếp lại lịch cho các buổi chưa hoàn thành.",
        rescheduleError: "Không thể xếp lại lịch",
        retry: "Vui lòng thử lại.",
        calculating: "Đang tính",
        paceAhead:
          "Bạn đang theo đúng hoặc nhanh hơn kế hoạch ({{percentage}}%).",
        paceSteady:
          "Bạn đang bám khá sát kế hoạch ({{percentage}}%).",
        paceBehind: "Bạn đang chậm hơn kế hoạch ({{percentage}}%).",
        paceBehindMissed:
          "Bạn đang chậm hơn kế hoạch ({{percentage}}%); hãy xếp lại lịch nếu cần.",
      },
      status: {
      ...
      session: {
        ...
        recommendedResources: "Tài nguyên học đề xuất",
        proTip: "Mẹo nhỏ",
        ...
        completeRequiredWork: "Hãy hoàn thành phần thực hành bắt buộc và thêm minh chứng.",
        readyToComplete: "Đã sẵn sàng hoàn tất buổi học",
        completeFailed: "Không thể hoàn tất buổi học. Vui lòng thử lại.",
        loadingRoadmap: "Đang tải lộ trình...",
        retry: "Thử lại",
        translateToVietnamese: "Dịch tiếng Việt",
        viewOriginal: "Xem bản gốc",
        close: "Đóng",
        savingProgress: "Đang lưu tiến độ...",
        progressSaveFailed: "Không thể lưu tiến độ. Vui lòng thử lại.",
        translationFailed: "Không thể dịch nội dung lúc này.",
        mode: {
          learn: "Tiếp tục học",
          practice: "Thực hành",
          check: "Kiểm tra kiến thức (không bắt buộc)",
        },
      },
      internal: {
        label: "Task nội bộ",
    ...
    billing: {
      ...
      pricing: {
        ...
        planDescriptions: {
          free: "Dùng thử các công cụ cốt lõi của SkillBridge",
          pro: "Gói công cụ nghề nghiệp AI hàng tháng",
          premium: "Đầy đủ công cụ CV, phỏng vấn và lộ trình nghề nghiệp",
        ...
        benefits: {
          upload: "Tải CV",
          reviewMatch: "Chấm CV hoặc so khớp CV–JD",
          create: "Tạo CV mới",
          rewrite: "AI viết lại nội dung CV",
          editExport: "Chỉnh sửa thủ công và xuất PDF",
        ...
        credit: {
          title: "Mua thêm lượt dùng",
          subtitle: "Lượt đã mua được dùng sau khi hết quota gói tháng.",
          units: "{{count}} lượt",
          ...
          buy: "Mua lượt",
          confirmTitle: "Xác nhận mua lượt",
          noDiscount: "Không giảm giá",
          pay: "Thanh toán an toàn",
        },
      ...
      me: {
        ...
        creditsTitle: "Lượt đã mua",
        noCredits: "Bạn chưa có lượt đã mua.",
        creditsError: "Không tải được số lượt đã mua của bạn.",
        retry: "Thử lại",
        voucherTitle: "Nhận lượt bằng voucher",
        voucherDescription: "Nhập mã tặng lượt CV hoặc phỏng vấn từ SkillBridge.",
        voucherLabel: "Mã voucher",
      ...
      admin: {
        ...
        vouchers: {
          ...
          subtitle: "Tạo và theo dõi voucher giảm giá Premium hoặc tặng lượt sử dụng.",
          create: "Tạo voucher",
          edit: "Sửa voucher",
          search: "Tìm theo mã voucher",
          statusFilter: "Lọc trạng thái voucher",
          allStatuses: "Tất cả trạng thái",
          statuses: {
          ...
          code: "Mã",
          reward: "Quyền lợi",
          benefitType: "Loại voucher",
          benefitTypes: {
            PERCENT_DISCOUNT: "Giảm giá Premium",
            CREDIT_GRANT: "Tặng lượt sử dụng",
          },
          discount: "Mức giảm (%)",
          creditType: "Loại lượt tặng",
          creditUnits: "Số lượt tặng",
          discountReward: "Giảm {{percent}}%",
          creditReward: "{{count}} lượt {{type}}",
          period: "Thời gian hiệu lực",
          usage: "Đã dùng / giữ chỗ",
          remaining: "Còn lại",
          enabled: "Đang bật",
          actions: "Thao tác",
          redeemed: "đã dùng",
          reserved: "đang giữ",
          empty: "Chưa có voucher phù hợp.",
          loadFailed: "Không tải được danh sách voucher",
          retry: "Thử lại",
          previous: "Trước",
          next: "Sau",
          startsAt: "Bắt đầu",
          ...
          note: "Ghi chú nội bộ",
          formDescription: "Mỗi voucher chỉ có một quyền lợi: giảm giá Premium hoặc tặng một loại lượt.",
          invalidPeriod: "Thời gian kết thúc phải sau thời gian bắt đầu.",
          immutable: "Mã, loại và quyền lợi đã bị khóa vì voucher đã phát sinh sử dụng.",
          toggleLabel: "Bật hoặc tắt voucher {{code}}",
          cancel: "Hủy",
          save: "Lưu",
        ...
        plans: {
          ...
          priceVnd: "Giá VND",
          sortOrder: "Thứ tự",
          creditUnits: "Số lượt cho mỗi lần mua",
          currency: "Tiền tệ",
          cancel: "Hủy",
          description: "Mô tả",
          features: "Tính năng",
    ...
    interview: {
      ...
      setup: {
        monthlyQuota: "Gói tháng: còn {{remaining}}/{{limit}} lượt phỏng vấn",
        quotaUnlimited: "Gói tháng: phỏng vấn không giới hạn",
        purchasedCredits: "Đã mua: {{count}} lượt phỏng vấn",
        progressive: {
      ...
      results: {
        ...
        semantic: "Ngữ nghĩa",
        llmScore: "Điểm LLM",
        technicalDepth: "Chiều sâu kỹ thuật",
        evidenceCredibility: "Độ tin cậy minh chứng",
        ...
        scoreBasis: {
          ...
          mixed: "Rubric + fallback cũ",
          unscored: "Chưa đủ dữ liệu chấm",
        },
        ...
        commFillerPerMin: "Từ đệm / phút",
        commResponseDelay: "Thời gian bắt đầu trả lời",
        commResponseDelayVal: "{{seconds}} giây",
        commSegments: "Số quãng nói",
        ...
        commExpand: "Chi tiết",
        commCollapse: "Thu gọn",
        commJdHitLabel: "Trúng từ khóa",
        phaseTimelineTitle: "Sơ đồ giai đoạn cuộc phỏng vấn",
        phaseNotReached: "Chưa phỏng vấn",
        gapCritical: "Lỗ hổng nghiêm trọng",
        gapModerate: "Lỗ hổng vừa",
        depth: {
  ...
  diagnosis: {
    ...
    upload: {
      ...
      uploadedOnlyTitle: "CV đã được lưu",
      uploadedOnlyDesc: "Bạn đã hết lượt phân tích CV. Hãy mua thêm lượt để phân tích CV đã lưu này.",
      buyAnalysisCredit: "Mua lượt phân tích CV",
      reviewSavedTitle: "Đã phân tích CV",
      matchFailedReviewSaved: "Kết quả phân tích CV đã được lưu, nhưng phần so khớp JD chưa hoàn tất.",
      ...
      loadingRoles: "Đang tải danh sách...",
      errorRoles: "Lỗi tải danh sách",
      emptyRoles: "Không có dữ liệu",
    ...
    review: {
      title: "Phân tích CV",
      matchTitle: "Kết quả khớp CV–JD",
      matchScoreTitle: "Điểm khớp CV–JD",
      matchAction: "So khớp CV với JD",
      matchAnotherAction: "So khớp JD khác",
      tabFit: "Mức độ phù hợp",
      tabCvJd: "CV & JD",
      tabJobs: "Việc làm liên quan",
      defaultJdName: "JD đã tải lên",
    ...
    jobs: {
      ...
      top5Title: "Top 5 việc làm phù hợp nhất",
      showTop5: "Xem Top 5 gọn",
      loadMore: "Tải thêm việc làm",
      loadingMore: "Đang tải thêm việc làm...",
      ...
      viewAllJobs: "Xem tất cả {{total}} việc làm",
      explorerTitle: "Khám phá việc làm phù hợp",
      filterTitle: "Bộ lọc",
      filterDescription:
      ...
      sourceFilter: "Nguồn tuyển dụng",
      districtFilter: "Quận/Huyện",
      dateRange: "Thời gian đăng",
      ...
      salaryRangeError: "Lương tối thiểu không được lớn hơn lương tối đa",
      explorerSubtitle: "Khám phá và lọc việc làm phù hợp với kỹ năng của bạn",
      applyFilters: "Áp dụng",
      ...
      roles: {
        ...
        mobile_developer: "Lập trình viên Mobile",
        devops_engineer: "Kỹ sư DevOps",
        qa_tester: "QA / Kiểm thử viên",
        ai_ml_engineer: "Kỹ sư AI / ML",
        ai_app_engineer: "Kỹ sư ứng dụng AI",
      },
      ...
      sort: {
        ...
        SKILL_MATCH: "Khớp kỹ năng",
        NEWEST: "Mới đăng",
        SALARY_DESC: "Lương cao",
      },
      fitFilter: {
        safe_apply: "Phù hợp để ứng tuyển",
        stretch: "Vị trí thử sức",
        not_recommended: "Chưa nên ưu tiên",
      },
      emptyPool: "Chưa có việc làm phù hợp cho vị trí này — thử đổi vị trí hoặc quay lại sau.",
      emptyFilter: "Không có kết quả với bộ lọc này.",
      salaryOnly: "Có hiển thị mức lương",
      cityLabel: "Địa điểm",
      workModeLabel: "Hình thức làm việc",
      employmentTypeLabel: "Loại hợp đồng",
      experienceLevelLabel: "Cấp bậc kinh nghiệm",
      fitLabel: "Đánh giá phù hợp",
      roleLabel: "Vị trí tuyển dụng",
      ...
      skillMatchLabel: "Khớp kỹ năng",
      strengths: "Điểm mạnh phù hợp",
      actionableGaps: "Cần bổ sung",
      moreGaps: "+{{count}} kỹ năng",
      viewDescription: "Xem mô tả",
      viewOpportunity: "Xem cơ hội",
      headingSafe: "Việc làm phù hợp để ứng tuyển",
      ...
      searchAria: "Tìm kiếm việc làm",
      locationLabel: "Địa điểm",
      roleAndWorkLabel: "Vai trò & Công việc",
      compensationAndSourceLabel: "Đãi ngộ & Nguồn",
      dateAndFitLabel: "Thời gian & Độ phù hợp",
      dateRangeLabel: "Thời gian đăng",
      salaryPeriods: {
        MONTH: "/tháng",
        YEAR: "/năm",
      },
    ...
    quota: {
      ...
      unlimited: "Gói hiện tại có lượt chấm CV không giới hạn",
      purchasedCredits: "Đã mua: {{count}} lượt CV",
    ...
    companion: {
      ...
      // Trợ lý viết CV (Slice 5) — chat góc màn hình trên builder. Câu mở đầu
      // là template TĨNH chỉ chèn TÊN SECTION yếu nhất; suggestions tĩnh.
      cvChat: {
        opener: "Bạn đang viết CV — mình có thể gợi ý cách diễn đạt, bổ sung bằng chứng, hoặc giải thích vì sao một phần chưa mạnh. Hỏi mình bất cứ điều gì!",
        openerWithGap: "Phần {{section}} trong CV có vẻ cần bổ sung — bạn muốn mình giúp cải thiện không?",
        ...
        limitReached:
          "Bạn đã dùng hết số câu hỏi cho trợ lý hôm nay — mỗi câu trả lời AI tốn chi phí thật, nên mình phải chia lượt. Mai quay lại mình tiếp nhé.",
        suggestions: [
          "Làm sao viết phần này hay hơn?",
          "Phần nào trong CV yếu nhất?",
          "Gợi ý cách bổ sung bằng chứng",
        ],
        provenance: "Dựa trên {{count}} dữ kiện",
        provenanceBullet: "bullet gốc: {{text}}",
        provenanceGap: "gap phát hiện: {{text}}",
        provenanceAnswer: "bạn đã nói: {{text}}",
        memoryTitle: "Cá heo đang nhớ gì",
        memoryRole: "Vai trò mục tiêu: {{value}}",
        memoryField: "Đang chỉnh sửa: {{value}}",
        memoryGaps: "Đã tư vấn: {{value}}",
        positioning: "Cá heo chỉ nhớ những gì bạn nói và CV thật của bạn.",
        applyTitle: "Đề xuất chỉnh sửa",
        applyBefore: "Trước",
        applyAfter: "Sau",
        applyButton: "Áp dụng",
        undoButton: "Hoàn tác",
        applySuccess: "Đã áp dụng thay đổi!",
        applyFailed: "Không thể áp dụng — hãy sửa thủ công.",
      },
    },
    skillsNudge: {
