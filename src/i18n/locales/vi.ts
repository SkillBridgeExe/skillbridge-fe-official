export default {
  ...
  diagnosis: {
    ...
    builder: {
      template: {
        azurill: { desc: "Mẫu ATS cổ điển với phần tiêu đề xanh dịu." },
        bronzor: { desc: "Bố cục sidebar chuyên nghiệp cho CV giàu hồ sơ cá nhân." },
        chikorita: { desc: "Bố cục chia cột gọn cho fresher kỹ thuật." },
        ditgar: { desc: "Cấu trúc timeline làm nổi bật câu chuyện kinh nghiệm." },
        ditto: { desc: "Phong cách tối giản, thoáng cho CV một trang sạch sẽ." },
        gengar: { desc: "Sidebar sáng tạo với mật độ cao cho CV nhiều dự án." },
        glalie: { desc: "Bố cục ATS chặt chẽ cho CV kỹ sư súc tích." },
        kakuna: { desc: "Timeline tông ấm cho câu chuyện phát triển nghề nghiệp." },
        lapras: { desc: "Bố cục cân bằng cho vai trò product và frontend." },
        leafish: { desc: "Thiết kế tối giản gọn cho CV học thuật hoặc thực tập." },
        meowth: { desc: "Typography lớn, dễ đọc cho phần tóm tắt nghề nghiệp." },
        onyx: { desc: "Sidebar chuyên nghiệp, sắc nét cho hồ sơ kỹ thuật." },
