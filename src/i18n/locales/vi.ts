export default {
  common: {
    ...
    learning: {
      page: {
        ...
        aiTip: "Gợi ý AI:",
        aiSummary: "Học {{count}} môn đã chọn theo số giờ rảnh mỗi ngày và số buổi mỗi tuần.",
        notFeasible: "",
      ...
      sidebar: {
        ...
        completedCompact: "{{done}}/{{total}} xong",
      ...
      sectionStatus: {
        learning: "Đang học",
        practiceNeeded: "Cần luyện tập",
        quizPassed: "Đã qua quiz",
        completed: "Hoàn thành",
      },
      evidence: {
        portfolioEvidence: "Minh chứng portfolio",
        summaryTitle: "Tóm tắt minh chứng",
        labProofAndQuiz: "Minh chứng lab {{completed}}/{{total}} - Quiz {{correct}}/{{quizTotal}}",
        readyForPortfolio: "Sẵn sàng cho portfolio",
        copySummary: "Sao chép tóm tắt",
        empty: "Hoàn thành ít nhất một task lab để tạo minh chứng portfolio.",
      },
      common: {
        week: "Tuần {{number}}",
        weekShort: "T{{number}}",
      ...
      session: {
        ...
        hideQuiz: "Ẩn quiz",
        passScoreShort: "Qua {{passing}}/{{total}}",
        correctAnswer: "Đúng",
        reviewThisAnswer: "Xem lại câu này",
        passingScore: "Điểm qua: đúng {{passing}}/{{total}} ({{percent}}%)",
        quizPassedCanComplete: "Bạn đã qua quiz. Có thể hoàn thành bài học.",
        reviewExplanationsBeforeComplete: "Xem lại phần giải thích và làm lại trước khi hoàn thành bài học.",
        chooseEveryAnswer: "Chọn đáp án cho mọi câu hỏi, rồi kiểm tra một lần.",
        youWillBeAbleTo: "Sau bài này bạn có thể",
        trySandbox: "Mở sandbox",
        incompleteSelfStudy: "Chưa hoàn thành nội dung tự học này",
        practiceRubric: "Tiêu chí thực hành",
        exampleProof: "Minh chứng mẫu",
        proofFor: "Minh chứng cho {{label}}",
        checkTask: "Kiểm tra task",
        addProofBeforeCheck: "Thêm minh chứng trước khi kiểm tra task này.",
  ...
  diagnosis: {
    ...
    results: {
      ...
      roadmapCvOnlyTitle: "Muốn tạo roadmap học từ lần quét này?",
      roadmapCvOnlyDesc:
        "Hãy so CV với một JD trước để SkillBridge tạo roadmap từ đúng khoảng trống của vị trí đó.",
      roleRoadmapTitle: "Tạo roadmap học từ CV này",
      roleRoadmapDesc:
        "SkillBridge sẽ so CV với baseline của vai trò đã chọn và tạo lộ trình học từ các kỹ năng còn thiếu hoặc mới đạt một phần.",
      generateCvRoadmap: "Tạo roadmap từ CV",
      generateMissingRoadmap: "Tạo roadmap học skill thiếu",
      scanAgain: "Chấm lại",
    ...
    roadmap: {
      ...
      free: "Miễn phí",
      advice: "Lời khuyên:",
      budgetSummary: "{{count}} môn đã chọn",
      selectionSummary: "Môn đã chọn luôn được đưa vào lộ trình; lịch học chỉ dựa trên số giờ rảnh mỗi ngày và số buổi mỗi tuần.",
      strategy: {
