    ...
    billing: {
      ...
      admin: {
        ...
        vouchers: {
          ...
          subtitle: "Tạo và theo dõi voucher giảm giá cho gói Premium.",
          create: "Tạo voucher",
          edit: "Sửa voucher",
          ...
          note: "Ghi chú nội bộ",
          formDescription: "Voucher chỉ áp dụng cho gói Premium và không cộng dồn.",
          invalidPeriod: "Thời gian kết thúc phải sau thời gian bắt đầu.",
          immutable: "Mã và phần trăm giảm đã bị khóa vì voucher đã phát sinh lượt giữ chỗ.",
