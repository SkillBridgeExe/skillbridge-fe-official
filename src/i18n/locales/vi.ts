  ...
  common: {
    ...
    interview: {
      ...
      setup: {
        ...
        criteriaDescription:
          "Phỏng vấn {{type}} cho {{role}}. Câu hỏi gốc sẽ dùng bank đã seed khi có; AI chỉ hỏi follow-up và chấm điểm thích ứng.",
        criteria: {
        ...
        questionBank: {
          curated: "Bank curated",
          fallback: "AI fallback",
          curatedTitle: "Question bank curated",
          curatedDescription:
            "Vai trò này dùng câu hỏi do SkillBridge tự biên soạn trước khi AI hỏi follow-up.",
          fallbackTitle: "Câu hỏi fallback tổng quát",
          fallbackDescription:
            "Vai trò này chưa được seed trong V1, backend sẽ fallback sang template question được generate.",
        },
        privacyScoringTitle: "Chấm điểm an toàn về privacy",
      ...
      results: {
        ...
        rubricBreakdownDescription:
          "Các dimension được backend chấm theo weight phù hợp với vai trò.",
        confidenceEvidence: "Hiệu chỉnh độ tự tin & bằng chứng",
        confidenceEvidenceDescription:
          "Tín hiệu an toàn về privacy dựa trên chất lượng câu trả lời, không dựa trên ngoại hình.",
        ...
        curatedQuestion: "Câu hỏi curated",
        fallbackQuestion: "Câu hỏi fallback",
        phase: "Phase",
        skill: "Skill",
        depthSignal: "Độ sâu",
