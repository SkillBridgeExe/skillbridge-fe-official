export default {
  common: {
    ...
    learning: {
      page: {
        ...
        aiTip: "AI Tip:",
        aiSummary: "Study {{count}} selected subjects with your chosen daily schedule.",
        notFeasible: "",
      ...
      evidence: {
        ...
        labProofAndQuiz: "Lab proof {{completed}}/{{total}} - Quiz {{correct}}/{{quizTotal}}",
        readyForPortfolio: "Ready for portfolio",
        copySummary: "Copy summary",
        empty: "Complete at least one lab task to build portfolio evidence.",
      },
      common: {
        week: "Week {{number}}",
        weekShort: "W{{number}}",
      ...
      session: {
        ...
        hideQuiz: "Hide quiz",
        passScoreShort: "Pass {{passing}}/{{total}}",
        correctAnswer: "Correct",
        reviewThisAnswer: "Review this answer",
        passingScore: "Passing score: {{passing}}/{{total}} correct ({{percent}}%)",
        quizPassedCanComplete: "Quiz passed. You can complete this lesson.",
        reviewExplanationsBeforeComplete: "Review the explanations and retry before completing this lesson.",
        chooseEveryAnswer: "Choose an answer for every question, then check once.",
        youWillBeAbleTo: "You will be able to",
        trySandbox: "Try Sandbox",
        incompleteSelfStudy: "This self-study section is not complete yet",
        practiceRubric: "Practice rubric",
        exampleProof: "Example proof",
        proofFor: "Proof for {{label}}",
        checkTask: "Check task",
        addProofBeforeCheck: "Add proof before checking this task.",
  ...
  diagnosis: {
    ...
    results: {
      ...
      roadmapCvOnlyTitle: "Want a learning roadmap from this scan?",
      roadmapCvOnlyDesc:
        "Compare your CV with a JD first so SkillBridge can build the roadmap from real role gaps.",
      roleRoadmapTitle: "Create a learning roadmap from this CV",
      roleRoadmapDesc:
      ...
      generateCvRoadmap: "Generate CV roadmap",
      generateMissingRoadmap: "Generate roadmap",
    ...
    roadmap: {
      ...
      free: "Free",
      advice: "Advice:",
      budgetSummary: "{{count}} selected subjects",
      selectionSummary: "Selected subjects are always included; the schedule uses your free hours per day and study days per week.",
      strategy: {
