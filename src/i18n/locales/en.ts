export default {
  common: {
    ...
    interview: {
      ...
      setup: {
        monthlyQuota: "Monthly plan: {{remaining}}/{{limit}} interviews left",
        quotaUnlimited: "Monthly plan: unlimited interviews",
        purchasedCredits: "Purchased: {{count}} interview credits",
        progressive: {
      ...
      results: {
        ...
        scoreBasis: {
          ...
          mixed: "Rubric + legacy fallback",
          unscored: "Insufficient scoring data",
        },
  ...
  diagnosis: {
    ...
    upload: {
      ...
      uploadedOnlyTitle: "Your CV has been saved",
      uploadedOnlyDesc: "You have no CV analysis usage left. Buy credits to analyze this saved CV.",
      buyAnalysisCredit: "Buy CV analysis credits",
      reviewSavedTitle: "CV review completed",
      matchFailedReviewSaved: "Your CV review is available, but the JD match could not be completed.",
      ...
      errorRoles: "Failed to load roles",
      emptyRoles: "No roles available",
    ...
    review: {
      ...
      matchAnotherAction: "Match another JD",
      tabFit: "Fit level",
      tabCvJd: "CV & JD",
    ...
    jobs: {
      ...
      salaryRangeError: "Minimum salary cannot exceed maximum salary",
      explorerSubtitle: "Explore and filter jobs matching your skills",
      applyFilters: "Apply",
      allRoles: "All roles",
      roles: {
        frontend_developer: "Frontend Developer",
        ...
        qa_tester: "QA / Tester",
        ai_ml_engineer: "AI / ML Engineer",
        ai_app_engineer: "AI Application Engineer",
      },
      ...
      actionableGaps: "Priority gaps",
      moreGaps: "+{{count}} skills",
      viewDescription: "View details",
      viewOpportunity: "View opportunity",
      headingSafe: "Jobs that fit your profile",
      ...
      roleAndWorkLabel: "Role & Work type",
      compensationAndSourceLabel: "Compensation & Source",
      dateAndFitLabel: "Date & Fit",
      dateRangeLabel: "Date posted",
      salaryPeriods: {
        MONTH: "/month",
        YEAR: "/year",
      },
    ...
    quota: {
      ...
      unlimited: "Unlimited CV reviews in your plan",
      purchasedCredits: "Purchased: {{count}} CV credits",
