  ...
  diagnosis: {
    ...
    builder: {
      ...
      actions: {
        ...
        versionHistoryPlaceholderDesc: "Version history will be available once cloud sync is enabled. For now, you can back up your current work using Export JSON Backup and restore it later using Import.",
      },
