export default {
  ...
  home: {
    ...
    process: {
      title: "Create a free, job-winning resume in 3 simple steps",
      subtitle: "Streamlined process to optimize your profile, build missing skills, and unlock job opportunities.",
      step1Title: "Upload & Scan Profile",
      step1Desc: "Submit your current CV. Our AI instantly extracts keyword matches, scans compatibility, and scores your standing.",
      step2Title: "Targeted Micro-Learning",
      step2Desc: "Follow dynamically-generated educational roadmaps to quickly build missing technical proficiencies.",
      step3Title: "Validate & Onboard",
      step3Desc: "Practice with AI mock interview tools and connect directly with verified corporate hiring partners.",
      cta: "Scan My CV Free",
      badge: "Get the job 2x faster",
      atsPill: "ATS-ready",
    },
    ...
    bento: {
      ...
      subtitle: "We leverage advanced AI analytics and professional workflows to accelerate your career transition.",
      diagEyebrow: "Deep AI Diagnosis",
      diagTitle: "Granular Skill Gap Analysis",
      diagDesc: "Upload your CV and match it directly against job descriptions. AI automatically calculates requirements and outlines exact missing skills.",
      diagCta: "Start Analysis",
      roadmapEyebrow: "Adaptive Roadmap",
      roadmapTitle: "Targeted Roadmaps",
      roadmapDesc: "We generate target-focused paths based on your gap analysis using efficient 20/80 study frameworks.",
      interviewEyebrow: "Real-time Practice",
      interviewTitle: "AI Simulation Practice",
      interviewDesc: "Refine your responses with voice dialogue, real-time expression tracking, and detailed scorecards detailing weaknesses.",
      interviewCta: "Try Simulator",
      builderEyebrow: "Builder",
      builderTitle: "ATS CV Builder",
      builderDesc: "Build a professional, recruitment-ready resume from scratch with interactive guidance.",
    },
    assess: {
